...
namespace System\Core{
	...
	class Uri {
		...
		public function __construct()
		{
			...
			if (Common::is_cli() OR $this->config->item('enable_query_strings') !== TRUE)
			{
				$this->_permitted_uri_chars = $this->config->item('permitted_uri_chars');

				// If it's a CLI request, ignore the configuration
				if (Common::is_cli() OR ($protocol = strtoupper($this->config->item('uri_protocol'))) === 'CLI')
				{
		...
		protected function _set_uri_string($str)
		{
			...
			$this->uri_string = trim(Common::remove_invisible_characters($str, FALSE), '/');
