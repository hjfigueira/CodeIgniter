...
namespace System\Core
{
	class Common
	{
		 ...
		 */
		static function is_php($version)
		{
			static $_is_php;
		 ...
		 * @return	array
		 */
		static function &get_config(Array $replace = array())
		{
			static $config;
		 ...
		 * @return	mixed
		 */
		static function config_item($item)
		{
			static $_config;
		 ...
		 * @return	void
		 */
		static function show_error($message, $status_code = 500, $heading = 'An Error Was Encountered')
		{
		 ...
		 * @return	void
		 */
		static function show_404($page = '', $log_error = TRUE)
		{
			$_error =& load_class('Exceptions', 'core');
		 ...
		 * @return	void
		 */
		static function log_message($level, $message)
		{
			static $_log;
		 ...
		 */
		static function html_escape($var, $double_encode = TRUE)
		{
			if (is_array($var))
			{
		 ...
		 * @return	string
		 */
		static function _stringify_attributes($attributes, $js = FALSE)
		{
			$atts = NULL;
		 ...
		 *			FALSE otherwise.
		 */
		static function function_usable($function_name)
		{
